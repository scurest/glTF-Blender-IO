...
from io_scene_gltf2.blender.exp import gltf2_blender_gather_animations_single_model
...
def gather_gltf2(export_settings):
    ...
    for blender_scene in bpy.data.scenes:
        ...
        if export_settings[gltf2_blender_export_keys.ANIMATIONS]:
            if export_settings['gltf_animation_mode'] == 'NORMAL':
                animations += __gather_animations(blender_scene, export_settings)
            elif export_settings['gltf_animation_mode'] == 'SINGLEMODEL':
                animations += gltf2_blender_gather_animations_single_model.gather_animations(scenes[-1], export_settings)
